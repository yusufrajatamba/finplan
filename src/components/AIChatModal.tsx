      ...
      <div className="bg-white dark:bg-slate-900 rounded-3xl max-w-2xl w-full h-[85vh] flex flex-col shadow-2xl border border-slate-200 dark:border-slate-800 overflow-hidden">
        ...
        <div className="px-4 py-2.5 bg-slate-50 dark:bg-slate-800/80 border-b border-slate-200 dark:border-slate-800 flex flex-wrap items-center justify-between gap-2 text-xs">
          <div className="flex items-center space-x-1.5 text-slate-600 dark:text-slate-300 font-medium">
            ...
            <span>Pakai Akun AI Anda Sendiri:</span>
          </div>
          <div className="flex items-center space-x-1.5">
            <button
              onClick={handleOpenChatGPT}
              className="px-2.5 py-1 rounded-lg bg-emerald-600 hover:bg-emerald-700 text-white font-medium flex items-center space-x-1 transition-all shadow-xs"
            ...
            <button
              ...
              className="px-2.5 py-1 rounded-lg bg-blue-600 hover:bg-blue-700 text-white font-medium flex items-center space-x-1 transition-all shadow-xs"
            ...
            <button
              ...
              className="px-2.5 py-1 rounded-lg bg-amber-700 hover:bg-amber-800 text-white font-medium flex items-center space-x-1 transition-all shadow-xs"
            ...
            <button
              ...
              className="px-2.5 py-1 rounded-lg bg-slate-200 dark:bg-slate-700 hover:bg-slate-300 dark:hover:bg-slate-600 text-slate-700 dark:text-slate-200 font-medium flex items-center space-x-1 transition-all"
